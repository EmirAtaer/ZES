...
import { MOCK_DATA, getTotalZESStations } from '../data/realData';
import { ProvinceData, AnalysisMetrics } from '../data/types';
import { getStationsForProvince, ChargingStation } from '../data/stationData';
import { REAL_EV_DATA, getZESMarketShare, getMarketGap, calculateInvestmentPriority, WORST_CITIES_FOR_EV } from '../data/evData';
import { calculateMarketOpportunity, getAllOpportunities, getOpportunityInsights, MarketOpportunityMetrics } from '../data/marketOpportunity';
import { 
        ...
        <div className="absolute top-6 right-6 bg-[#0b0f1a]/95 backdrop-blur-md border border-slate-700 rounded-xl px-5 py-3 shadow-2xl z-[1000]">
          ...
          <div className="mt-2 pt-2 border-t border-slate-700/50">
            <p className="text-[9px] text-slate-500">Türkiye Geneli: {(() => {
              const total = Object.values(REAL_EV_DATA).reduce((sum, d) => sum + d.totalStations, 0);
...
const App: React.FC = () => {
  ...
  const totalStats = useMemo(() => {
    ...
    const turkeyTotalStations = Object.values(REAL_EV_DATA).reduce((sum, data) => sum + data.totalStations, 0);
    
    // ZES pazar payını hesapla
    const zesMarketShare = (totalZESStations / turkeyTotalStations) * 100;
      ...
      <header className="bg-[#161b2a] border-b border-slate-800 px-6 py-4 shrink-0">
        ...
        <div className="grid grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-[#0b0f1a] border border-slate-800 rounded-xl p-4">
            ...
            <p className="text-3xl font-black text-white">%34.7</p>
            <p className="text-xs text-slate-400 font-bold mt-1">ZES Penetrasyonu</p>
          </div>

          <div className="bg-[#0b0f1a] border border-slate-800 rounded-xl p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-slate-500 font-bold uppercase">EV sahipleri şarj altyapısını yeterli görüyor mu?</span>
            </div>
            <p className="text-3xl font-black text-white flex items-center gap-2">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 4L12 20" stroke="#22c55e" stroke-width="3" stroke-linecap="round"/>
                <path d="M6 10L12 4L18 10" stroke="#22c55e" stroke-width="3" stroke-linecap="round"/>
              </svg>
              %78
            </p>
            <div className="mt-2 pt-2 border-t border-slate-800/50">
              <p className="text-[10px] text-slate-600">Kullanıcı anketi sonucu</p>
            </div>
          </div>
        </div>
      </header>
                    ...
                    <div className="h-[400px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <RadarChart data={comparisonData.radarData}>
                          ...
                          />
                          <Tooltip 
                            contentStyle={{backgroundColor: '#fff', border: '2px solid #22c55e', borderRadius: '10px', color: '#0b0f1a', fontWeight: 700, fontSize: 15}}
                            itemStyle={{color: '#0b0f1a', fontWeight: 700, fontSize: 15}}
                            labelStyle={{color: '#22c55e', fontWeight: 900, fontSize: 16}}
                          />
                        </RadarChart>
                      </ResponsiveContainer>
                    </div>
                    ...
                    <div className="h-[350px]">
                      <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={[
                          ...
                          <XAxis dataKey="name" tick={{ fill: '#94a3b8', fontSize: 12 }} axisLine={false} />
                          <YAxis tick={{ fill: '#94a3b8', fontSize: 10 }} axisLine={false} />
                          <Tooltip contentStyle={{backgroundColor: '#fff', border: '2px solid #22c55e', borderRadius: '10px', color: '#0b0f1a', fontWeight: 700, fontSize: 15}} itemStyle={{color: '#0b0f1a', fontWeight: 700, fontSize: 15}} labelStyle={{color: '#22c55e', fontWeight: 900, fontSize: 16}} />
                  ...
                  <div className="bg-[#161b2a] border-2 border-orange-500/40 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Şehirlerin EV sayısı, büyüme potansiyeli ve ZES pazar payı dikkate alınarak hesaplanır.)</div>
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Her ilin toplam EV sayısı ile şarj altyapısı kapsama oranı karşılaştırılır.)</div>
                        <div className="h-[300px]">
                          <ResponsiveContainer width="100%" height="100%">
                            <ScatterChart>
                  ...
                  <div className="bg-[#161b2a] border-2 border-orange-500/40 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6">
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Bütçe, şehirlerin yatırım skoruna göre orantılı olarak dağıtılır.)</div>
                        <div className="h-[400px]">
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Her şehrin yatırım skoru, EV sayısı, büyüme potansiyeli ve ZES pazar payı dikkate alınarak hesaplanır.)</div>
                        <div className="h-[400px]">
                          <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={topInvestmentTargets.slice(0, 10)}>
                              <CartesianGrid strokeDasharray="3 3" stroke="#334155" vertical={false} />
                    ...
                    <div className="bg-[#0b0f1a] rounded-lg p-6 mt-6">
                      ...
                      <div className="text-xs text-slate-400 mb-2">(Her şehir için ayrılan bütçe, yatırım skoruna göre belirlenmiştir.)</div>
                  ...
                  <div className="bg-[#161b2a] border-2 border-orange-500/40 rounded-xl p-6">
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Şehirler, toplam EV sayısına göre pazar büyüklüğü kategorilerine ayrılır.)</div>
                        <div className="h-[300px]">
                          <ResponsiveContainer width="100%" height="100%">
                            <PieChart>
                              <Pie
              ...
              {activeDecision === 4 && (
                <div className="space-y-6">
                  <div className="bg-[#161b2a] border-2 border-red-500/40 rounded-xl p-6">
                    ...
                    {/* Key Metrics */}
                    <div className="grid grid-cols-3 gap-8 mb-6 w-full max-w-full">
                      <div className="bg-red-500/10 border border-red-500/30 rounded-lg p-6 w-full">
                      ...
                      <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-6 w-full">
                      ...
                      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-6 w-full">
                      ...
                      {/* Sağlıklı İstasyonlar kutusu kaldırıldı */}
                    </div>

                    {/* Şehir Bazlı KPI Kategorileri Bar Chart (Seçili Şehirler) */}
                    <div className="bg-[#0b0f1a] rounded-lg p-6 mb-6">
                      <h4 className="text-lg font-black text-white mb-4">Riskli / İzlenmeli / Ort. Performans Şehirler</h4>
                      <div className="text-xs text-slate-400 mb-2">(Yatırım Öncelik Skoru: EV sayısı, büyüme potansiyeli ve ZES pazar payı düşük olan şehirler önceliklidir.)</div>
                      <div className="h-[350px] overflow-x-auto">
                        <ResponsiveContainer width={"100%"} height={"100%"} minWidth={700}>
                          <BarChart
                            data={(() => {
                              const all = getAllOpportunities().sort((a, b) => a.investmentPriority - b.investmentPriority);
                              const riskli = all.filter(o => o.investmentPriority < 30).slice(0, 10).map(o => ({
                                sehir: o.city,
                                skor: o.investmentPriority,
                                kategori: 'Riskli'
                              }));
                              const izlenmeli = all.filter(o => o.investmentPriority >= 30 && o.investmentPriority < 50).slice(0, 5).map(o => ({
                                sehir: o.city,
                                skor: o.investmentPriority,
                                kategori: 'İzlenmeli'
                              }));
                              const ort = all.filter(o => o.investmentPriority >= 50 && o.investmentPriority < 70).slice(0, 10).map(o => ({
                                sehir: o.city,
                                skor: o.investmentPriority,
                                kategori: 'Ort. Performans'
                              }));
                              return [...riskli, ...izlenmeli, ...ort];
                            })()}
                            margin={{ top: 20, right: 30, left: 0, bottom: 5 }}
                          >
                            <CartesianGrid strokeDasharray="3 3" stroke="#334155" />
                            <XAxis dataKey="sehir" tick={{ fill: '#94a3b8', fontSize: 12 }} axisLine={false} interval={0} angle={-30} textAnchor="end" height={80} />
                            <YAxis tick={{ fill: '#94a3b8', fontSize: 14 }} axisLine={false} allowDecimals={false} />
                            <Tooltip 
                              contentStyle={{backgroundColor: '#fff', border: '2px solid #22c55e', borderRadius: '10px', color: '#0b0f1a', fontWeight: 700, fontSize: 15}}
                              itemStyle={{color: '#0b0f1a', fontWeight: 700, fontSize: 15}}
                              labelStyle={{color: '#22c55e', fontWeight: 900, fontSize: 16}}
                              formatter={(value, name, props) => [`${value}`, 'Yatırım Öncelik Skoru']}
                              labelFormatter={label => `Şehir: ${label}`}
                            />
                            <Bar dataKey="skor" name="Yatırım Öncelik Skoru">
                              {(() => {
                                const all = getAllOpportunities().sort((a, b) => a.investmentPriority - b.investmentPriority);
                                const riskli = all.filter(o => o.investmentPriority < 30).slice(0, 10);
                                const izlenmeli = all.filter(o => o.investmentPriority >= 30 && o.investmentPriority < 50).slice(0, 5);
                                const ort = all.filter(o => o.investmentPriority >= 50 && o.investmentPriority < 70).slice(0, 10);
                                return [...riskli.map(o => <Cell key={o.city} fill="#ef4444" />),
                                        ...izlenmeli.map(o => <Cell key={o.city} fill="#facc15" />),
                                        ...ort.map(o => <Cell key={o.city} fill="#3b82f6" />)];
                              })()}
                            </Bar>
                          </BarChart>
                        </ResponsiveContainer>
                    ...
                    <div className="bg-[#0b0f1a] rounded-lg p-6">
                      ...
                      <div className="text-xs text-slate-400 mb-2">(Kapatma önerisi: Çok düşük EV, büyüme ve performans skoruna sahip şehirler için önerilir.)</div>
                      <div className="overflow-x-auto">
                        <table className="w-full">
                          <thead>
                            <tr className="border-b-2 border-slate-700">
                ...
                <div className="space-y-6">
                  <div className="bg-[#161b2a] border-2 border-green-500/40 rounded-xl p-6">
                    ...
                    <div className="bg-[#0b0f1a] rounded-lg p-6 mb-6">
                      ...
                      <div className="text-xs text-slate-400 mb-2">(EV sayısı, büyüme potansiyeli ve ZES pazar payı yüksek olan şehirler önceliklidir.)</div>
                      <div className="h-[400px]">
                        <ResponsiveContainer width="100%" height="100%">
                          <BarChart
                    ...
                    <div className="grid grid-cols-2 gap-6 mb-6">
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        <h4 className="text-lg font-black text-white mb-4">En İyi 5 Yeni Pazar Fırsatı</h4>
                        <div className="text-xs text-slate-400 mb-2">(Fırsat Skoru: Büyüme potansiyeli ve EV sayısı yüksek, ZES pazar payı düşük şehirler.)</div>
                      ...
                      <div className="bg-[#0b0f1a] rounded-lg p-6">
                        ...
                        <div className="text-xs text-slate-400 mb-2">(Her şehir için ZES pazar payı ile büyüme potansiyeli karşılaştırılmıştır.)</div>
                        <div className="h-[300px]">
                          <ResponsiveContainer width="100%" height="100%">
                            <ScatterChart>
                              <CartesianGrid strokeDasharray="3 3" stroke="#334155" />
